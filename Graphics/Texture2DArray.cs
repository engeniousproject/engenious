...
namespace engenious.Graphics
{
    public class Texture2DArray : Texture
    {
        ...
        public void SetData<T>(T[] data,int layer)where T : struct
        {
            ...
            ThreadingHelper.BlockOnUIThread(() =>
            {
                ...
                GL.TexSubImage3D(TextureTarget.Texture2DArray, 0, 0, 0,layer, Width, Height,1, OpenTK.Graphics.OpenGL4.PixelFormat.Bgra, pxType, handle.AddrOfPinnedObject());
            });
            handle.Free();
        }
    }
